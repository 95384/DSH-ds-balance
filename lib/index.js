...
export default {
  ...
  apply(ctx) {
    ...
    async function loadBalance() {
      // The credential reference is a plain environment-variable name resolved
      // at runtime by the harness credentials service. No static import of
      // harness-internal packages keeps this plugin loadable from any install
      // location, including a local link: checkout.
